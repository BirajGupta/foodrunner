...
import com.rak12.mod3app.fragment.Faq
import com.rak12.mod3app.fragment.Favourites
import com.rak12.mod3app.fragment.Home
import com.rak12.mod3app.fragment.Profile
   ...
   lateinit var toolbar:Toolbar
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       toolbar=findViewById(R.id.toolbar)
        ...
        val actionBarDrawerToggle=ActionBarDrawerToggle(this,dl,
            R.string.opendrawer,
        ...
        nv.setNavigationItemSelectedListener {
            ...
            when(it.itemId)
            {
                ...
                R.id.fav -> {
                    supportFragmentManager.beginTransaction().replace(R.id.frame, Favourites()).commit()
                ...
                R.id.logout->{
                    ...
                    builder.setTitle("Confirmation")
                        ...
                        .setPositiveButton("Yes") { _, _ ->sp.edit().clear().apply()
    ...
    override fun onBackPressed() {
        var id=supportFragmentManager.findFragmentById(R.id.frame)
        if(id ==Home()){
//               Volley.newRequestQueue(this).cancelAll(this::class.java.simpleName)
//            super.onBackPressed()
            ActivityCompat.finishAffinity(this)
